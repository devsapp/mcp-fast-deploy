...
class _CredentialsProviderWrap:
    ...
    def __init__(self, *, type_name: str = None, provider: ICredentialsProvider = None):
...
class Client:
    ...
    def __init__(self, config: Config = None, provider: ICredentialsProvider = None):
        if provider is not None:
            self.cloud_credential = _CredentialsProviderWrap(
                type_name=provider.get_provider_name(), provider=provider
            )
        elif config is None:
            provider = DefaultCredentialsProvider()
            self.cloud_credential = _CredentialsProviderWrap(
                type_name="default", provider=provider
            )
        else:
    ...
    def get_credentials(config):
        if config.type == ac.ACCESS_KEY:
            ...
            return _CredentialsProviderWrap(
                type_name="credentials_uri", provider=provider
            )
            ...
            return _CredentialsProviderWrap(
                type_name="oidc_role_arn", provider=provider
            )
