...
class DefaultCredentialsProvider(ICredentialsProvider):
    ...
    def __init__(self, *, reuse_last_provider_enabled: bool = True):

        self.__reuse_last_provider_enabled = reuse_last_provider_enabled
        self.__last_used_provider = None

        self.__providers_chain = [EnvironmentVariableCredentialsProvider()]
        ...
        if (
            au.environment_credentials_uri is not None
            and au.environment_credentials_uri != ""
        ):
