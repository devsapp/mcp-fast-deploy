    ...
    def __init__(
        ...
        *,
        ...
        self._oidc_token_file_path = (
            oidc_token_file_path or au.environment_oidc_token_file
        )
        ...
        self._runtime_options = {
            "connectTimeout": (
                ...
                else OIDCRoleArnCredentialsProvider.DEFAULT_CONNECT_TIMEOUT
            ),
            "readTimeout": (
                self._http_options.read_timeout
                if self._http_options.read_timeout is not None
                else OIDCRoleArnCredentialsProvider.DEFAULT_READ_TIMEOUT
            ),
