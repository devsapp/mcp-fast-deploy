...
class ProfileCredentialsProvider(ICredentialsProvider):
    ...
    def __init__(self, *, profile_file: str = None, profile_name: str = None):
        ...
        if self._should_reload_credentials_provider():
            ...
            if section is None:
                raise CredentialException(
                    f"failed to get credential from credentials file: ${self._profile_file}"
                )
    ...
    def _get_credentials_provider(self, section: Dict) -> ICredentialsProvider:
        ...
        if "access_key" == config_type:
            ...
            return EcsRamRoleCredentialsProvider(role_name=section.get("role_name"))
