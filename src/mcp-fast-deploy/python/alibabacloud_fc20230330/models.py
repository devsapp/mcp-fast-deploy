...
class CreateFunctionInput(TeaModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get("customContainerConfig") is not None:
            ...
            self.custom_container_config = temp_model.from_map(
                m["customContainerConfig"]
            )
        ...
        if m.get("instanceLifecycleConfig") is not None:
            ...
            self.instance_lifecycle_config = temp_model.from_map(
                m["instanceLifecycleConfig"]
            )
...
class EventSourceParameters(TeaModel):
    ...
    def to_map(self):
        ...
        if self.source_rabbit_mqparameters is not None:
            result["sourceRabbitMQParameters"] = (
                self.source_rabbit_mqparameters.to_map()
            )
        if self.source_rocket_mqparameters is not None:
            result["sourceRocketMQParameters"] = (
                self.source_rocket_mqparameters.to_map()
            )
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get("sourceKafkaParameters") is not None:
            ...
            self.source_kafka_parameters = temp_model.from_map(
                m["sourceKafkaParameters"]
            )
        ...
        if m.get("sourceRabbitMQParameters") is not None:
            ...
            self.source_rabbit_mqparameters = temp_model.from_map(
                m["sourceRabbitMQParameters"]
            )
        if m.get("sourceRocketMQParameters") is not None:
            temp_model = SourceRocketMQParameters()
            self.source_rocket_mqparameters = temp_model.from_map(
                m["sourceRocketMQParameters"]
            )
        return self
...
class EventSourceConfig(TeaModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get("eventSourceParameters") is not None:
            ...
            self.event_source_parameters = temp_model.from_map(
                m["eventSourceParameters"]
            )
...
class Function(TeaModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get("invocationRestriction") is not None:
            ...
            self.invocation_restriction = temp_model.from_map(
                m["invocationRestriction"]
            )
        if m.get("lastModifiedTime") is not None:
            self.last_modified_time = m.get("lastModifiedTime")
