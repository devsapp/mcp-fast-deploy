...
class Client(object):
    ...
    def to_form(filter):
        ...
        return Util.to_form_string(Util.anyify_map_value(result))
    ...
    def get_authorization(request, sign_type, payload, ak, secret):
        ...
        canonicalized_headers, signed_headers = get_canonicalized_headers(
            request.headers
        )
