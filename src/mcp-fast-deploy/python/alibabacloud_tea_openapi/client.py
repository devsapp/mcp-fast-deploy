...
class Client:
    ...
    def __init__(
        ...
        if not UtilClient.empty(config.access_key_id) and not UtilClient.empty(
            ...
            cc = credential_models.Config(
                type="bearer", bearer_token=config.bearer_token
            )
            ...
            try:
                ...
                if not UtilClient.equal_string(auth_type, "Anonymous"):
                    ...
                    if UtilClient.equal_string(credential_type, "bearer"):
                        ...
                        _request.query["Signature"] = (
                            OpenApiUtilClient.get_rpcsignature(
    ...
    def do_roarequest(
        ...
        while TeaCore.allow_retry(_runtime.get("retry"), _retry_times, _now):
            ...
            try:
                ...
                _request.query = TeaCore.merge(global_queries, extends_queries)
                if not UtilClient.is_unset(request.query):
                    _request.query = TeaCore.merge(_request.query, request.query)
                if not UtilClient.equal_string(auth_type, "Anonymous"):
                    if UtilClient.is_unset(self._credential):
                        raise TeaException(
                            {
                    ...
                    if UtilClient.equal_string(credential_type, "bearer"):
                        ...
                        _request.headers["authorization"] = (
                            f"acs {access_key_id}:{OpenApiUtilClient.get_roasignature(string_to_sign, access_key_secret)}"
                        )
                _last_request = _request
                _response = TeaCore.do_action(_request, _runtime)
            ...
            try:
                ...
                if UtilClient.equal_string(params.style, "RPC"):
                    ...
                    if not UtilClient.is_unset(headers):
                        _request.headers = TeaCore.merge(_request.headers, headers)
                signature_algorithm = UtilClient.default_string(
                    self._signature_algorithm, "ACS3-HMAC-SHA256"
                )
                hashed_request_payload = OpenApiUtilClient.hex_encode(
                    OpenApiUtilClient.hash(UtilClient.to_bytes(""), signature_algorithm)
                )
                if not UtilClient.is_unset(request.stream):
                    tmp = UtilClient.read_as_bytes(request.stream)
                    hashed_request_payload = OpenApiUtilClient.hex_encode(
                        OpenApiUtilClient.hash(tmp, signature_algorithm)
                    )
                    _request.body = tmp
                    ...
                    if not UtilClient.is_unset(request.body):
                        if UtilClient.equal_string(params.req_body_type, "byte"):
                            ...
                            hashed_request_payload = OpenApiUtilClient.hex_encode(
                                OpenApiUtilClient.hash(byte_obj, signature_algorithm)
                            )
                            ...
                            hashed_request_payload = OpenApiUtilClient.hex_encode(
                                OpenApiUtilClient.hash(
                                    UtilClient.to_bytes(json_obj), signature_algorithm
                                )
                            )
                            ...
                            hashed_request_payload = OpenApiUtilClient.hex_encode(
                                OpenApiUtilClient.hash(
                                    UtilClient.to_bytes(form_obj), signature_algorithm
                                )
                            )
                ...
                if UtilClient.is_4xx(_response.status_code) or UtilClient.is_5xx(
                    ...
                    ) and UtilClient.equal_string(
                        _response.headers.get("content-type"), "text/xml;charset=utf-8"
                    ):
        ...
        while TeaCore.allow_retry(_runtime.get("retry"), _retry_times, _now):
            ...
            try:
                ...
                request_context = spi_models.InterceptorContextRequest(
                    headers=TeaCore.merge(
                        global_headers, extends_headers, request.headers, headers
                    ),
                    query=TeaCore.merge(global_queries, extends_queries, request.query),
                    body=request.body,
                ...
                configuration_context = spi_models.InterceptorContextConfiguration(
                    ...
                    endpoint=UtilClient.default_string(
                        request.endpoint_override, self._endpoint
                    ),
                ...
                interceptor_context = spi_models.InterceptorContext(
                    request=request_context, configuration=configuration_context
                )
    ...
    async def execute_async(
        ...
        while TeaCore.allow_retry(_runtime.get("retry"), _retry_times, _now):
            ...
            try:
                ...
                attribute_map = spi_models.AttributeMap()
                # 1. spi.modifyConfiguration(context: SPI.InterceptorContext, attributeMap: SPI.AttributeMap);
                await self._spi.modify_configuration_async(
                    interceptor_context, attribute_map
                )
                # 2. spi.modifyRequest(context: SPI.InterceptorContext, attributeMap: SPI.AttributeMap);
                ...
                interceptor_context.response = response_context
                # 3. spi.modifyResponse(context: SPI.InterceptorContext, attributeMap: SPI.AttributeMap);
                await self._spi.modify_response_async(
                    interceptor_context, attribute_map
                )
                return {
                    "headers": interceptor_context.response.headers,
    ...
    def call_api(
        ...
        if UtilClient.is_unset(params):
            raise TeaException(
                {"code": "ParameterMissing", "message": "'params' can not be unset"}
            )
        if UtilClient.is_unset(self._signature_version) or not UtilClient.equal_string(
            self._signature_version, "v4"
        ):
            if UtilClient.is_unset(
                self._signature_algorithm
            ) or not UtilClient.equal_string(self._signature_algorithm, "v2"):
                return self.do_request(params, request, runtime)
            elif UtilClient.equal_string(
                params.style, "ROA"
            ) and UtilClient.equal_string(params.req_body_type, "json"):
                return self.do_roarequest(
                    params.action,
                    params.version,
                    params.protocol,
                    params.method,
                ...
                return self.do_roarequest_with_form(
                    params.action,
                    params.version,
                    params.protocol,
                    params.method,
    ...
    async def call_api_async(
        ...
        if UtilClient.is_unset(self._signature_version) or not UtilClient.equal_string(
            ...
            if UtilClient.is_unset(
                ...
                return await self.do_roarequest_async(
                    params.action,
                    params.version,
                    params.protocol,
                    params.method,
                ...
                return await self.do_roarequest_with_form_async(
                    params.action,
                    params.version,
                    params.protocol,
                    params.method,
                ...
                return await self.do_rpcrequest_async(
                    params.action,
                    params.version,
                    params.protocol,
                    params.method,
